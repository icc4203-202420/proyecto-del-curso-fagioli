...
ActiveRecord::Schema[7.1].define(version: 2024_11_04_031036) do
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.index ["user_id", "event_picture_id"], name: "index_tags_on_user_id_and_event_picture_id", unique: true
